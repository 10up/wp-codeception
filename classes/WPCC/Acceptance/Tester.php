<?php //[STAMP] c845cb1110fce2fed44550eb7edf60fc
// This class was automatically generated by build task
// You should not change it manually as it will be overwritten on next build
// @codingStandardsIgnoreFile

namespace WPCC\Acceptance;
...
class Tester extends \Codeception\Actor {
	 ...
	 *
	 * @access public
	 * @see \WPCC\Module\WebDriver::clearCookies()
	 */
	public function clearCookies() {
		return $this->scenario->runStep( new \Codeception\Step\Action( 'clearCookies', func_get_args() ) );
	}
	 ...
	 *
	 * @access public
	 * @see \WPCC\Module\WordPress::amOnLoginPage()
	 */
	public function amOnLoginPage() {
		return $this->scenario->runStep( new \Codeception\Step\Condition( 'amOnLoginPage', func_get_args() ) );
	}
	 ...
	 * @see \WPCC\Module\WordPress::amOnAdminPage()
	 */
	 ...
	 * @see \WPCC\Module\WordPress::submitLoginForm()
	 */
	public function submitLoginForm( $username, $password, $display_name ) {
		return $this->scenario->runStep( new \Codeception\Step\Action( 'submitLoginForm', func_get_args() ) );
	}
